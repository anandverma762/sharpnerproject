...
function signup() {
    ...
    axios.post('https://crudcrud.com/api/7d123723f05343ffa3440ed1c46292a0/reg',user).then(m=>console.log("Sent"));
...
function show(mr){
  ...
  del.value = "Delete";
  del.onclick = () => {
      axios.delete(`https://crudcrud.com/api/7d123723f05343ffa3440ed1c46292a0/reg/${m._id}`).then();
      r.removeChild(ct);
  }
  let ed = document.createElement("input");
  ed.type = 'button';
...
if(f===0){
  ...
  window.onload = function () {
    axios.get('https://crudcrud.com/api/7d123723f05343ffa3440ed1c46292a0/reg').then(mess=>{
      show(mess.data)});
